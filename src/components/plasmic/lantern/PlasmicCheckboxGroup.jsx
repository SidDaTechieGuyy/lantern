...
import Checkbox from "../../Checkbox"; // plasmic-import: CtcfJ0TMdujz/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: s-XMRdbU5UVV/css
...
function PlasmicCheckboxGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___3RclJ)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__muyP3)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__nAimQ)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___4LhI3)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
