...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: PEUjSI1T2KVc/css
...
function PlasmicMenuItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___7Zfns)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__oImFy)}>
            <div
              className={classNames(
                projectcss.all,
