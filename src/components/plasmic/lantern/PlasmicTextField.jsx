...
import TextInput from "../../TextInput"; // plasmic-import: FStf6F0hESqx/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 0ZYHDimCY8BO/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: CEziULxVQwLk/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__iFl5, {
          [sty.freeBoxiconEnd__iFl5Sv7SX]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__iFl5GOtvV]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__iFl5F8Dyi]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___2YIda, {
            [sty.freeBoxiconStart___2YIdagOtvV]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___2YIdAf8Dyi]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___2On9W)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__j894A, {
            [sty.freeBoxiconEnd__j894Asv7SX]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__j894AgOtvV]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__c2Pit)}
                role={"img"}
              />
            ),
