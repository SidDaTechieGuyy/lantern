...
import Radio from "../../Radio"; // plasmic-import: n90Gb_T11hJo/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: mlKIAAl9rngw/css
...
function PlasmicRadioGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__skUwq)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__gMpre)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__ohIia)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___3VFq8)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
