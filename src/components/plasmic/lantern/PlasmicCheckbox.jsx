...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: CtcfJ0TMdujz/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 9OzRlpmcI4-J/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: VnLtIEcejHPa/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg___2F042)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__e6UkQ)}
            role={"img"}
          />
        ) : null}
      </div>
