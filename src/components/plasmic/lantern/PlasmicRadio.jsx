...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: n90Gb_T11hJo/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__qYeWk)}>
        <div className={classNames(projectcss.all, sty.freeBox__van7R)} />
      </div>
      {renderPlasmicSlot({
