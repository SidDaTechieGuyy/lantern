...
import SliderThumb from "../../SliderThumb"; // plasmic-import: SzzPlqylFqpT/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: -i_XXQHk3ELN/css
...
function PlasmicRangeSlider__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__fiybt)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__mfidM)}>
        <div
