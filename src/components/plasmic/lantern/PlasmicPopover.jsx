...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: QlSMH3_kF-6g/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: bh0CT6v4665k/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__aQl7Y)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__dl0A)}
            label={"Open Popover"}
          />
        ),
